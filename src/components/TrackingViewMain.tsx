        ...
        <div className={classes["tracking-view"]}>
            ...
            <div className={classes["tracking-view__container"]}>
                <div className={classes["tracking-view__system"]}>
                    ...
                    <Button title={activiteBtnSystem ? "On" : "Off"} className="system-btn" onClick={handleSetSystemBtn} colorCode={colorCode} activiteBtnSystem={activiteBtnSystem} />
                </div>
            ...
            {trackingModal && <TrackingResult trackingInfo={trackingInfo} colorCode={colorCode} handleTrackingModal={handleTrackingModal} activiteBtnSystem={activiteBtnSystem} />}
            {/* <div>
